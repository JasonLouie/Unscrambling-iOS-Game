//
//  OptionsHudView.swift
//  Word Unscrambling Game
//
//  Created by Jason Louie on 5/7/22.
//

import UIKit

class OptionsHudView: UIView{
    var text = ""
    
    class func hud(inView view: UIView, animated: Bool) -> OptionsHudView {
        let hudView = OptionsHudView(frame: view.bounds)
